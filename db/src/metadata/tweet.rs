...
impl TweetMetadata {
    ...
    pub fn from_data_tweet(
        snapshot: &birdsite::model::wbm::data::Tweet,
    ) -> Result<Vec<Self>, birdsite::model::wbm::data::FormatError> {
    ...
    fn extract_flat_tweet(results: &mut Vec<Self>, snapshot: &birdsite::model::wbm::v1::Tweet) {
    ...
    ) -> Result<Self, birdsite::model::wbm::data::FormatError> {
