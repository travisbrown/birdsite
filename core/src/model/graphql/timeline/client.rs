...
pub mod event {
    ...
    pub enum TransparentGuideDetails<'a> {
        TimelineEventUrtMetadata {
            ...
            #[serde(rename = "eventId", with = "crate::model::attributes::id_str")]
            event_id: u64,
        },
        ...
        TimelineSemanticCoreInterest {
            #[serde(rename = "domainId", with = "crate::model::attributes::id_str")]
            domain_id: u64,
            #[serde(rename = "entityId", with = "crate::model::attributes::id_str")]
            entity_id: u64,
        },
    }
